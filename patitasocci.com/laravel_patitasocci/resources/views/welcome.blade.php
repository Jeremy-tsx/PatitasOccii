            ...
            <nav class="navbar navbar-expand-lg custom_nav-container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="service1.html">Servicio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="pet.php">Adopciones</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="buy.php">Productos</a>
                        </li>
                    ...
                    <div class="d-block d-lg-none mt-0 text-center">
                        <a href="../proyecto_patitasocci/laravel_patitasocci/public/login"
                            class="btn btn-primary w-75 mb-2">Iniciar Sesión</a>
                        <a href="../proyecto_patitasocci/laravel_patitasocci/public/register"
                            class="btn btn-secondary w-75">Registrarse</a>
                    </div>
                    ...
                    <div class="d-none d-lg-flex align-items-center">
                        <div class="dropdown">
                            <a href="#" class="nav-link dropdown-toggle" id="userDropdown" role="button"
                                ...
                                <img src="images/usuario.png" alt="User Icon" class="user-icon">
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="userDropdown">
                                <li><a class="dropdown-item"
                                        href="../proyecto_patitasocci/laravel_patitasocci/public/login">Iniciar
                                        Sesión</a></li>
                                <li><a class="dropdown-item"
                                        href="../proyecto_patitasocci/laravel_patitasocci/public/register">Registrarse</a>
                                </li>
                            </ul>
                        </div>
                    </div>
              ...
              <div class="row"> 
                <div class="col-md-4 offset-md-2">
                  <div class="slider_detail-box">
                    ...
                    <div class="btn-box">
                      <a href="service1.html" class="btn-1" style="text-decoration: none;">
                        Nuestros Servicios
                      </a>
                      <a href="clinic.html" class="btn-2" style="text-decoration: none;">
                        Nosotros
                      </a>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-md-4 offset-md-2">
                  <div class="slider_detail-box">
                    ...
                    <p></p>
                    <div class="btn-box">
                      <a href="pet.php" class="btn-1" style="text-decoration: none;">
                        Nuestros animales
                      </a>
                      <a href="contact.php" class="btn-2" style="text-decoration: none;">
                        Contacto
                      </a>
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="slider_logo-box">
                    ...
                    <a href="https://www.facebook.com/patitasocci" target="_blank" class="social-link"><img src="images/face.png" alt="Facebook"></a>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <div>
              <a href="clinic.html"style="text-decoration: none;">
                Más Información 
              </a>
            </div>
          </div>
 ...
 <section class="service_section layout_padding">
    <div class="container-fluid">
      <div class="row">
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="detail_box">
                  ...
                  <p>
                    Facilita a los potenciales adoptantes encontrar el animal que mejor se adapte a sus necesidades y preferencias.
                  </p>
              ...
              <div class="col-md-4">
                ...
                <div class="detail_box">
                  ...
                  <p>
                    Ofrecemos acceso a una amplia gama de servicios veterinarios para asegurar que las mascotas adopten una vida saludable y feliz. 
                  </p>
                </div>
              </div>
        ...
        <div>
          <a  href="service1.html" class="btn-box">Leer Más</a>
        </div>
        <div class="col-md-4">
        </div>
      </div>
      ...
      <div class="row">
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            // Cada seis mascotas, cierra la fila y abre una nueva
            if ($itemCount % 3 == 0 && $itemCount != 0) {
              echo '</div></div><div class="carousel-item"><div class="row">';
            }

            echo '<div class="col-md-4 col-12">'; // col-12 para que ocupe una fila completa en dispositivos pequeños
            echo '  <div class="card">';
            echo '    <a href="info.php?id_mascota=' . $row["id_mascota"] . '">';
            echo '      <img src="images/' . $row["foto"] . '" class="card-img-top" alt="Imagen de ' . $row["nombre"] . '">';
            echo '    </a>';
            echo '    <div class="card-body">';
            echo '      <h5 class="card-title">Nombre: ' . $row["nombre"] . '</h5>';
            echo '      <p class="card-text">' . $row["historia"] . '</p>';
            echo '      <button class="btn btn-primary" style="border-radius:10px" onclick="window.location.href=\'info.php?id_mascota=' . $row["id_mascota"] . '\'">Ver detalles</button>';
            echo '    </div>';
            echo '  </div>';
            echo '</div>';
              ...
              <div class="row">
                  ...
                  <div class="col-md-4 mb-5">
                      ...
                      <div class="d-flex flex-column justify-content-start pt-3">
                          ...
                          <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Adopciones</a>
