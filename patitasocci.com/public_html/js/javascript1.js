...
// Muestra los filtros en responsive de adopciones
document.addEventListener('DOMContentLoaded', () => {
    ...
    toggleButton.addEventListener('click', () => {
        ...
        toggleButton.textContent = isVisible ? 'Mostrar Filtros' : 'Ocultar Filtros';
    });
});


document.querySelector('#carouselExampleIndicators').addEventListener('slide.bs.carousel', () => {
    document.activeElement.blur(); // Evita que el navegador enfoque el contenido del slide
});
